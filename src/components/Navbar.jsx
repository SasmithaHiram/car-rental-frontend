  ...
  return (
    ...
    >
      ...
      <div
        ...
        } ${open ? "max-sm:translate-x-0" : "max-sm:transalate-x-full"}`}
      >
        ...
        <div className="hidden lg:flex items-center text-sm gap-2 border border-borderColor px-3 rounded-full max-2-56">
          <input
            type="text"
